    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                ...
                <?php 
					$text = "This is a simple hero unit, a simple jumbotron-style component for<br>
calling extra attention to featured content or information.";
					$first = substr($text,0,10); // Показывает 6 символов начиная с 0-ого, самого первого
					echo $first;
					?>
...
<section id="feat">
    <div class="container">
        <div class="row features">
            	<?php
for ($row = 0; $row < 3; $row++) {
echo '<div class="col-md-4 text-center wow fadeInUp" data-wow-delay="'.$tizer[$row]["Adelay"].'">
<span class="typcn typcn-'.$tizer[$row]["icon"].' x3"></span>
<h4>'.$tizer[$row]["title"].'</h4>
<p>'.$tizer[$row]["text"].'</p>
</div>';
}
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-6">
							<form action="mail_action.php">
							<input type="text" class="form-control" name="mail_footer" placeholder="Your Email Here...">
                            <br>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h3>Your Logo</h3>
                <p>© 2016 - <?php echo date("Y"); ?> Your Company. Designed and Developed by
